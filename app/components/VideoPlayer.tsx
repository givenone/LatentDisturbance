...
export function VideoPlayer({src,label,color='#555',autoPlay=true,loop=true,playbackRate=1,onEnded,disabled=false}:{src:string;label:string;color?:string;autoPlay?:boolean;loop?:boolean;playbackRate?:number;onEnded?:()=>void;disabled?:boolean}){
