...
const navItems=[{id:'overview',label:'Overview'},{id:'formulation',label:'Robust Optimization'},{id:'method',label:'Uncertainty Set'},{id:'hardware',label:'Experiment: Real World'},{id:'simulation',label:'Experiment: Simulation'}];
