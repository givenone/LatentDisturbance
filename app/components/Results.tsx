...
export function Results({kind='hardware'}:{kind?:'hardware'|'simulation'}){
 ...
 <div className="result-heading"><h3 className="experiment-heading" id="hw-surfaces">Robust to disturbances: different spatula surfaces</h3><div className="segmented"><button onClick={()=>setReplay('tape_results')} aria-pressed={replay==='tape_results'}>Replay failure trajectories</button><button onClick={()=>setReplay('tape_results_safe')} aria-pressed={replay==='tape_results_safe'}>Replay success trajectories</button></div></div>
